...
class PositionManager:
    ...
    def _size_pairs(self, 
        ...
        Args:
            ...
            total_portfolio_value: Total portfolio value from update_portfolio_value()
        """
        ...
        try:
            ...
            if len(mu) == 0 or S.shape[0] == 0:
                logger.warning("Empty covariance matrix, using equal allocation")
                return self._equal_allocation(pairs_dict, total_portfolio_value)
            ...
            if self.risk_method == 'min_volatility':
                ...
                logger.warning(f"Unknown risk_method {self.risk_method}, using equal allocation")
                return self._equal_allocation(pairs_dict, total_portfolio_value)
